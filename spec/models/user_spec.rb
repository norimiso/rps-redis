  ...
  describe ".create" do
    ...
    context "user not already added" do
      it "should create user" do
        User.create(iidxid: "1111-1111", djname: "test")
        @redis.smembers("users").should include "1111-1111"
    ...
    context "user already added" do
      it "should update his djname" do
        @redis.sadd("users", "1111-1111")
        @redis.hset("users:1111-1111", :djname, "test1")
        User.create(iidxid: "1111-1111", djname: "test2")
        @redis.hget("users:1111-1111", :djname).should == "test2"
      end
    end
  end
end
